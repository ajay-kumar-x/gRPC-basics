...
public final class AuthServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<org.example.grpc.Auth.Credential,
      org.example.grpc.Auth.responseMessage> getLoginMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "login",
      requestType = org.example.grpc.Auth.Credential.class,
      responseType = org.example.grpc.Auth.responseMessage.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<org.example.grpc.Auth.Credential,
      org.example.grpc.Auth.responseMessage> getLoginMethod() {
    io.grpc.MethodDescriptor<org.example.grpc.Auth.Credential, org.example.grpc.Auth.responseMessage> getLoginMethod;
    if ((getLoginMethod = AuthServiceGrpc.getLoginMethod) == null) {
      synchronized (AuthServiceGrpc.class) {
        if ((getLoginMethod = AuthServiceGrpc.getLoginMethod) == null) {
          AuthServiceGrpc.getLoginMethod = getLoginMethod = 
              io.grpc.MethodDescriptor.<org.example.grpc.Auth.Credential, org.example.grpc.Auth.responseMessage>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "AuthService", "login"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.example.grpc.Auth.Credential.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.example.grpc.Auth.responseMessage.getDefaultInstance()))
  ...
  public static abstract class AuthServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void login(org.example.grpc.Auth.Credential request,
        io.grpc.stub.StreamObserver<org.example.grpc.Auth.responseMessage> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                org.example.grpc.Auth.Credential,
                org.example.grpc.Auth.responseMessage>(
                  this, METHODID_LOGIN)))
          .build();
    }
  }
  ...
  public static final class AuthServiceBlockingStub extends io.grpc.stub.AbstractStub<AuthServiceBlockingStub> {
    ...
    /**
     */
    public org.example.grpc.Auth.responseMessage login(org.example.grpc.Auth.Credential request) {
  ...
  public static final class AuthServiceFutureStub extends io.grpc.stub.AbstractStub<AuthServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<org.example.grpc.Auth.responseMessage> login(
        org.example.grpc.Auth.Credential request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_LOGIN:
          serviceImpl.login((org.example.grpc.Auth.Credential) request,
              (io.grpc.stub.StreamObserver<org.example.grpc.Auth.responseMessage>) responseObserver);
          break;
        default:
  ...
  private static abstract class AuthServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return org.example.grpc.Auth.getDescriptor();
    }
